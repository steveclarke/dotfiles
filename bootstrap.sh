...
echo "1. Download .dotfilesrc: wget -qO ~/.dotfilesrc https://raw.githubusercontent.com/steveclarke/dotfiles/feature/macos/.dotfilesrc.template"
...
# Original bootstrap.sh content below
...
if bootstrap_confirm; then
	...
	echo ""
	echo "Next steps:"
	echo "1. cd ~/.local/share/dotfiles"
