...
keymap.set("n", "U", "<C-r>", default_options)
...
keymap.set("n", "<A-u>", ":m .+1<CR>==", default_options)
keymap.set("n", "<A-i>", ":m .-2<CR>==", default_options)
keymap.set("i", "<A-u>", "<Esc>:m .+1<CR>==gi", default_options)
keymap.set("i", "<A-i>", "<Esc>:m .-2<CR>==gi", default_options)
keymap.set("v", "<A-u>", ":m '>+1<CR>gv-gv", default_options)
keymap.set("v", "<A-i>", ":m '<-2<CR>gv-gv", default_options)

-- Better indenting
keymap.set("v", "<", "<gv", default_options)
keymap.set("v", ">", ">gv", default_options)
...
keymap.set("n", "<C-_>", "<Plug>(comment_toggle_linewise_current)", default_options)
keymap.set("x", "<C-_>", "<Plug>(comment_toggle_linewise_visual)gv", default_options)
...
keymap.set("n", "<C-Up>", ":resize -2<CR>", default_options)
keymap.set("n", "<C-Down>", ":resize +2<CR>", default_options)
keymap.set("n", "<C-Left>", ":vertical resize -2<CR>", default_options)
keymap.set("n", "<C-Right>", ":vertical resize +2<CR>", default_options)

-- Copy the current line or visual selection down
keymap.set("n", "<leader>yp", ":copy .<cr>", options({ desc = "Yank and paste line" }))
keymap.set("n", "<C-d>", ":copy .<cr>", default_options)
keymap.set("v", "<leader>yp", ":copy '<,'>.<CR>", options({ desc = "Yank and paste selection" }))
keymap.set("v", "<C-d>", ":copy '<,'>.<CR>", default_options)
