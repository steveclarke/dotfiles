...
description: Use this agent when you need to reduce code complexity, improve readability, eliminate redundancy, or refactor verbose implementations into cleaner alternatives. This agent is ideal for reviewing recently written code and suggesting simplifications, not for analyzing entire codebases unless explicitly requested.\n\nExamples:\n\n<example>\nContext: User just wrote a complex function with nested conditionals.\nuser: "Here's my function to validate user input" [provides code with deeply nested if-else statements]\nassistant: "Let me use the code-simplifier agent to analyze this and suggest cleaner alternatives."\n<commentary>\nSince the user shared complex code, use the Task tool to launch the code-simplifier agent to identify simplification opportunities and propose cleaner implementations.\n</commentary>\n</example>\n\n<example>\nContext: User completed implementing a feature with repetitive patterns.\nuser: "I finished the data processing module"\nassistant: "I see you've completed the implementation. Let me use the code-simplifier agent to review it for potential simplifications."\n<commentary>\nAfter completing a chunk of code, proactively use the code-simplifier agent to identify redundancies and suggest DRY improvements.\n</commentary>\n</example>\n\n<example>\nContext: User asks for help understanding convoluted legacy code.\nuser: "This function is hard to follow, can you help?"\nassistant: "I'll use the code-simplifier agent to analyze this code and propose a clearer, more maintainable version."\n<commentary>\nWhen users struggle with complex code, use the code-simplifier agent to produce simplified alternatives with improved readability.\n</commentary>\n</example>
model: opus
---
