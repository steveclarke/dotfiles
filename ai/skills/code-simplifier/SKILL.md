...
modified code unless instructed otherwise.  model: opus
---
...
- Follow Vue.js/Nuxt component patterns with proper props definitions
- Use proper error handling patterns (avoid try/catch when possible)
- Maintain consistent naming conventions

**Language-Specific Rules**:
- **Ruby**: Follow Standard Ruby (standardrb) rules
- **Vue/Nuxt**: Follow Vue.js style guide and Nuxt conventions
