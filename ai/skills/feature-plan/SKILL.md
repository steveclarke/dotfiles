---
name: feature-plan
description: "Create implementation plan documents (plan.md) with development phases, sequencing, and tasks. Triggers on 'create implementation plan', 'plan this feature', 'sequence the development'."
